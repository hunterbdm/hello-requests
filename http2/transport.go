...
// SetT1 allows you to set the http1.Transport so you can apply settings to the http2.Transport
func (t *Transport) SetT1(t1 *http.Transport) {
	t.t1 = t1
}
...
func (cc *ClientConn) encodeHeaders(req *http.Request, addGzipHeader bool, trailers string, contentLength int64) ([]byte, error) {
	...
	enumerateHeaders := func(f func(name, value string)) {
		...
		// Changed the order of these default http2 headers to match chromes order
		m := req.Method
		if m == "" {
			m = http.MethodGet
		}
